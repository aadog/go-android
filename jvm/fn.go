...
type JniFieldRet interface {
	*ObjectWrapper | string | int | *string | int64 | bool
}
...
func ObjectWrapperGetFieldValue[T JniFieldRet](o *ObjectWrapper, Field string) mo.Result[any] {
	env := LocalThreadJavaEnv()
...
func ClassWrapperStaticCall[T JniCallRet](o *ClassWrapper, funcName string, args ...any) mo.Result[any] {
	env := LocalThreadJavaEnv()
